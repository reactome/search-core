...
class EnricherUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(EnricherUtil.class);
     ...
     */
    public static List<EntityReference> getEntityReferences(GKInstance instance, String fieldName) throws EnricherException {
     ...
     * @throws EnricherException
     */
    public static EntityReference getEntityReferenceHelper(GKInstance instance) throws EnricherException {
        if (instance != null) {
            try {
    ...
    public static String getStableIdentifier(GKInstance instance) throws Exception {
     ...
     * @throws EnricherException
     */
    public static String getAttributeString(GKInstance instance, String fieldName) throws EnricherException {
     ...
     * @throws EnricherException
     */
    public static Integer getAttributeInteger(GKInstance instance, String fieldName) throws EnricherException {
        if (hasValue(instance, fieldName)) {
            try {
     ...
     * @throws EnricherException
     */
    public static List<String> getAttributes(GKInstance instance, String fieldName) throws EnricherException {
        if (hasValues(instance, fieldName)) {
            try {
     ...
     * @throws EnricherException
     */
    public static EntityReference getEntityReference(GKInstance instance, String fieldName) throws EnricherException {
        if (hasValue(instance, fieldName)) {
            try {
     ...
     * @throws EnricherException
     */
    public static List<GoTerm> getGoTerms(GKInstance instance, String fieldName) throws EnricherException {
        if (hasValues(instance, fieldName)) {
     ...
     * @throws EnricherException
     */
    public static GoTerm getGoTerm(GKInstance instance) throws EnricherException {
     ...
     * @throws EnricherException
     */
    public static Map<String, List<Regulation>> getRegulations(GKInstance instance, String fieldName) throws EnricherException {
     ...
     * @throws EnricherException
     */
    public static Regulation getRegulation(GKInstance instance) throws EnricherException {
        try {
     ...
     * @throws EnricherException
     */
    public static Database getDatabase(GKInstance instance, String identifier) throws EnricherException {
    ...
    public static List<String> getAttributesDisplayNames(GKInstance instance, String fieldName) throws EnricherException {
        if (hasValues(instance, fieldName)) {
            try {
     ...
     */
    @SuppressWarnings("SameParameterValue")
    public static String getAttributeDisplayName(GKInstance instance, String fieldName) throws EnricherException {
        if (hasValues(instance, fieldName)) {
            try {
     ...
     * @throws EnricherException
     */
    public static Map<String, List<CrossReference>> getCrossReferences(GKInstance instance, String fieldName, Map<String, List<CrossReference>> map) throws EnricherException {
        if (hasValues(instance, fieldName)) {
            try {
                if (map == null) {
                    map = new HashMap<>();
     ...
     * @throws EnricherException
     */
    public static List<EntityReference> getReferredEntityReferences(Long dbID, GKInstance instance) throws EnricherException {
        try {
     ...
     */
    public static boolean hasValue(GKInstance instance, String fieldName) throws EnricherException {
     ...
     * @return true if field has values
     */
    public static boolean hasValues(GKInstance instance, String fieldName) throws EnricherException {
        if (instance != null && instance.getSchemClass().isValidAttribute(fieldName)) {
            try {
